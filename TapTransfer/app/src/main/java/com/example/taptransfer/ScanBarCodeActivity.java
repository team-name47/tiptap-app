                ...
                if (barcodes.size() != 0) {
                    txtBarcodeValue.post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            txtBarcodeValue.setText("Decoding QR code");
                            Intent i = new Intent(ScanBarCodeActivity.this, ConfirmTransaction.class);
                            String[] d = intentData.split(",");
                            //Toast.makeText(getApplicationContext() , "To prevent" + d.length , Toast.LENGTH_SHORT).show();
                            //d.length
